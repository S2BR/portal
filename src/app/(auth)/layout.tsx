...
export default async function AuthLayout({
  ...
  return (
    <div className="grid min-h-svh lg:grid-cols-2">
      ...
      <aside className="relative hidden overflow-hidden bg-gradient-to-br from-[var(--auth-panel-from)] via-[var(--auth-panel-via)] to-[var(--auth-panel-to)] lg:flex lg:flex-col lg:justify-center lg:p-12 ltr:shadow-[inset_-16px_0_28px_-16px_rgba(0,0,0,0.4)] rtl:shadow-[inset_16px_0_28px_-16px_rgba(0,0,0,0.4)]">
